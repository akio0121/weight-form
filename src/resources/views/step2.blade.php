        ...
        <div class="step2-form__inner">
            <form class="step2-form__form" action="/register/step2" method="post">
                ...
                <div class="step2-form__group">
                    ...
                    <input class="step2-form__input" type="integer" name="weight" id="weight" placeholder="現在の体重を入力">
                ...
                <div class="step2-form__group">
                    ...
                    <input class="step2-form__input" type="integer" name="target_weight" id="target_weight" placeholder="目標の体重を入力">
                    <p class="step2-form__error-message">
                        @error('target_weight')
                        {{ $message }}
                        @enderror
